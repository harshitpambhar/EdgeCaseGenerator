...
import RequirementMappingPage from './pages/requirements/RequirementMappingPage';
        ...
        <SidebarProvider>
          <Routes>
            ...
            <Route element={<DashboardLayout />}>
              ...
              <Route
                path="/requirements"
                element={<ProtectedRoute element={<RequirementsPage />} />}
              />

              <Route
                path="/requirement-mapping"
                element={<ProtectedRoute element={<RequirementMappingPage />} />}
              />
