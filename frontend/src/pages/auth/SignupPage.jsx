    ...
    >
      ...
      <div className="rounded-xl bg-white/[0.03] border border-white/[0.08] p-7">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)}
                placeholder="you@example.com" className={`pl-9 ${inputClass('email')}`} />
            </div>
          ...
          <Button type="submit" className="w-full bg-indigo-500 hover:bg-indigo-400 text-white border-none h-9">
            Create account
          </Button>
        </form>
